...
| requirement-shell-cli-default-interaction | shell | TP-CLI-14 · **TP-CLI-21** · TP-KEY-04..07 · TP-KEY-16 · TP-CFG-17 · TP-CFG-22 | Numbered tree 1/2/8/9; TTY **82** / typed `version` run about; unknown choice redisplay |
...
| requirement-domain-key | domain | TP-CLI-04, TP-CLI-14, TP-CLI-21, **TP-KEY-01..09**, **TP-KEY-16**, **TP-CFG-01..24** | help rows; menu 1/2/8/9; Termux/Git Bash/Windows hide backup; removed sshd/client verbs unknown; archive deposit |
